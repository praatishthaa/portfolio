...
const Projects = () => {
  return (
    <section
      id="projects"
      className="py-20 bg-gradient-to-b from-purple-50 via-white to-indigo-50 dark:from-gray-800 dark:via-gray-900 dark:to-gray-800"
    >
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <ProjectCard
            ...
            tech="React, Tailwind CSS, Recharts, Geolocation API, Leaflet"
          ...
          {/* Add more <ProjectCard />s here if needed */}
        </div>
      </div>
    </section>
  );
